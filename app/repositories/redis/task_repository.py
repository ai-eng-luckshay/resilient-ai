...
def _get_redis_client():
    raise NotImplementedError(
        ...
        "to activate.  See app/repositories/redis/task_repository.py for full wiring instructions."
    )
...
class RedisSessionStore:
    """
    Replaces: app/repositories/memory/session_repository.py :: SessionStore
...
class RedisContextStore:
    """
    Replaces: app/repositories/memory/context_repository.py :: ContextStore
