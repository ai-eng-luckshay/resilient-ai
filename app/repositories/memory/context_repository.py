...
from app.repositories.base.context_repository import IContextRepository


class ContextStore(IContextRepository):
...
def get_context_store() -> ContextStore:
    ...
    if settings.use_redis:
        ...
        # See app/repositories/redis/context_repository.py — RedisContextStore implements
        # the same interface.
        from app.repositories.redis.context_repository import RedisContextStore
